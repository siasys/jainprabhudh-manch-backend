...
const { createBiodata, updateBiodata, getBiodata, getAllBiodatas, checkUserBiodata, getBiodataByUserId, deleteBiodata, updateBiodataImages } = require('../../controller/Matrimonial/vyavahikBiodataController');
