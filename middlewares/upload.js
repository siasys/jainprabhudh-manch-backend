...
// ✅ FIX 1: sharp.concurrency(1) add kiya - ek waqt ek image process (RAM bachata hai)
sharp.cache(false);
sharp.concurrency(1);
...
try {
  ...
  console.warn(
    "⚠️ @ffmpeg-installer/ffmpeg not found. Video compression may not work.",
  );
}
...
// Memory storage (purana wala - jo kaam karta tha)
const upload = multer({
...
module.exports.candidateResumeUpload = [
  upload.fields([{ name: "candidateResume", maxCount: 1 }]),
  compressFiles,
  uploadToS3,
];
module.exports.jaintihasUpload = [
  upload.single("image"),
  compressFiles,
  uploadToS3,
];
module.exports.jainGranthUpload = [
  upload.fields([
...
module.exports.govtYojanaUpload = [
  upload.single("file"),
  compressFiles,
  uploadToS3,
];
...
module.exports.tirthDocs = [
  upload.fields([{ name: "tirthPhoto", maxCount: 10 }]),
  compressFiles,
  uploadToS3,
];
module.exports.expenseBillUpload = [
  upload.fields([{ name: "uploadBill", maxCount: 1 }]),
  compressFiles,
  uploadToS3,
];
...
module.exports.uploadActivityFiles = [
  upload.fields([{ name: "uploadActivity", maxCount: 5 }]),
  compressFiles,
  uploadToS3,
];
...
module.exports.sponsorUpload = [
  upload.fields([{ name: "sponserImage", maxCount: 1 }]),
  compressFiles,
  uploadToS3,
];
